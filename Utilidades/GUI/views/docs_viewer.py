...
class DocsViewerView(ctk.CTkFrame):
    ...
    def __init__(self, master, colors: dict, **kwargs):
        ...
        self.doc_list.pack(fill="both", expand=True, padx=6, pady=(0, 8))
        ...
        self.doc_text.pack(fill="both", expand=True, padx=10, pady=(5, 10))
    ...
    def _load_docs(self, filter_text: str = ""):
        ...
        for filename in files:
            ...
            btn = ctk.CTkButton(
                self.doc_list,
                text=f"{icon} {filename[:20]}{'...' if len(filename) > 20 else ''}",
