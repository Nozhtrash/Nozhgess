...
NOMBRE_DE_LA_MISION: str = "Artritis Juvenil"
...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Trabajo Oficina\Archivos\Nóminas\2\ICEP 2° Quincena - Reumatología (135) - Diciembre.xlsx"
...
MISSIONS: List[Dict[str, Any]] = [
    {
        ...
        "nombre": "Artritis Idiopatica",

        # Keywords para buscar en mini-tabla y cartola (case-insensitive)
        "keywords": ["idiopatica", "idiopática juvenil" "artritis idiopatica", "artritis reumatoidea juvenil"],
