...
NOMBRE_DE_LA_MISION: str = "Tamizajes"
...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Tamizajes Enero 2026 (Hasta 14-01).xlsx"
...
INDICE_COLUMNA_RUT: int = 0      # Columna B (RUT del paciente)
INDICE_COLUMNA_NOMBRE: int = 1   # Columna C (nombre del paciente)
