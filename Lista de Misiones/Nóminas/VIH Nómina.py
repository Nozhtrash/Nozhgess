...
NOMBRE_DE_LA_MISION: str = "VIH NOMINA"
...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Trabajo Oficina\Archivos\Nóminas\N2\IE 2° Quincena - Infectología (199) - Noviembre.xlsx"

# Carpeta donde se guardará el Excel de revisión - Pega la ruta completa aquí
RUTA_CARPETA_SALIDA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Trabajo Oficina\Revisiones, Falta Enviar, CM, Listos\Revisiones\Revisiones VIH"
...
CODIGOS_FOLIO_BUSCAR: List[str] = ["2504092"]
...
MISSIONS: List[Dict[str, Any]] = [
    {
        ...
        "objetivos": ["3107215", "3107314", "2506019"],

        # Códigos de habilitantes (vacío = no buscar)
        "habilitantes": ["2508015", "2504092", "2505839", "2505872", "2505876", "2505877"],
