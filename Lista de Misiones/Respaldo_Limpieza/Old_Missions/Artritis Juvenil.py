...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Trabajo Oficina\Archivos\Nóminas\Artitis Juvenil.xlsx"
...
MISSIONS: List[Dict[str, Any]] = [
    {
        ...
        "keywords": ["idiopatica", "idiopática juvenil" "artritis idiopatica"],
