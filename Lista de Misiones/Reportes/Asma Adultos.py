...
NOMBRE_DE_LA_MISION: str = "Asma Mayores"
...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\knoth\OneDrive\Documentos\Trabajo Oficina\Archivos\Reportes\Asma Mayores.xlsx"
...
MISSIONS: List[Dict[str, Any]] = [
    {
        ...
        "keywords": ["Asma Bronquial Adulto", "asma bronquial adulto"],

        # Códigos de objetivos a buscar en prestaciones
        "objetivos": [],

        # Códigos de habilitantes (vacío = no buscar)
        "habilitantes": ["3902002", "3902003", "3902004", "3902005", "3902006"],
