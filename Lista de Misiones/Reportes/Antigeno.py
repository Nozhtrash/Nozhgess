...
NOMBRE_DE_LA_MISION: str = "Antigeno"
...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Trabajo Oficina\Archivos\Reportes\Antígeno Prostático 1° Quincena (300) - Diciembre.xlsx"

# Carpeta donde se guardará el Excel de revisión - Pega la ruta completa aquí
RUTA_CARPETA_SALIDA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Trabajo Oficina\Revisiones, Falta Enviar, CM, Listos\Revisiones\Revisiones Reportes"
...
INDICE_COLUMNA_RUT: int = 3      # Columna B (RUT del paciente)
...
MISSIONS: List[Dict[str, Any]] = [
    {
        ...
        # Keywords para buscar en mini-tabla y carto, la (case-insensitive)
        "keywords": ["cancer de prostata", "prostata", "cáncer de próstata", "próstata"],

        # Códigos de objetivos a buscar en prestaciones
        "objetivos": ["0305070", "305070"],
