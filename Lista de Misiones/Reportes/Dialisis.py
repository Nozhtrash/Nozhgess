...
NOMBRE_DE_LA_MISION: str = "Dialisis"
...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Trabajo Oficina\Archivos\Extras\Diálisis - Diciembre.xls"
...
MISSIONS: List[Dict[str, Any]] = [
    {
        ...
        "keywords": ["enfermedad renal", "enfermedad renal crónica", "enfermedad renal cronica", "renal cronica"],

        # Códigos de objetivos a buscar en prestaciones
        "objetivos": [],

        # Códigos de habilitantes (vacío = no buscar)
        "habilitantes": ["1901028"],
