...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\usuariohgf\OneDrive\Documentos\Trabajo Oficina\Archivos\Reportes\AIJ.xlsx"
...
REVISAR_HABILITANTES: bool = False
...
MISSIONS: List[Dict[str, Any]] = [{
        ...
        "keywords": ["artritis idiopática", "artritis idopatica juvenil", "artritis juvenil ."],

        # Códigos de objetivos a buscar en prestaciones
        "objetivos": [],
        
        # Habilitantes (controlado por REVISAR_HABILITANTES global)
        "habilitantes": ["2505290", "2505292"],

        # Excluyentes (controlado por REVISAR_EXCLUYENTES global)
        "excluyentes": [],
