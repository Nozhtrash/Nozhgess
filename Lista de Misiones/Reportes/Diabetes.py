...
RUTA_ARCHIVO_ENTRADA: str = r"C:\Users\knoth\OneDrive\Documentos\Trabajo Oficina\Archivos\Reportes\D2.xlsx"

# Carpeta donde se guardará el Excel de revisión - Pega la ruta completa aquí
RUTA_CARPETA_SALIDA: str = r"C:\Users\knoth\OneDrive\Documentos\Trabajo Oficina\Revisiones, Falta Enviar, CM, Listos\Revisiones\Revisiones Reportes"
...
MISSIONS: List[Dict[str, Any]] = [
    {
        # -----------------------------------------------------------------
        #                    MISIÓN 1: Diabetes Mellitus 2
        # -----------------------------------------------------------------
        
        # Nombre descriptivo de la misión
        "nombre": "Diabetes Mellitus 2",

        # Keywords para buscar en mini-tabla y cartola (case-insensitive)
        "keywords": ["diabetes mellitus II", "diabetes mellitus tipo 2", "diabetes mellitus tipo II", "mellitus II", "mellitus 2"],

        # Códigos de objetivos a buscar en prestaciones
        "objetivos": [],

        # Códigos de habilitantes (vacío = no buscar)
        "habilitantes": ["5002101"],
    ...
    },
    {
        ...
        # Keywords para buscar en mini-tabla y cartola (case-insensitive)
        "keywords": ["diabetes mellitus I", "diabetes mellitus tipo 1", "diabetes mellitus tipo I", "mellitus I", "mellitus 1"],

        # Códigos de objetivos a buscar en prestaciones
        "objetivos": [],

        # Códigos de habilitantes (vacío = no buscar)
        "habilitantes": ["3102001", "3102002"],
